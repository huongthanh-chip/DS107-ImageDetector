...
Nguon raw hien tai:
- 01-data/raw/Real Image
- 01-data/raw/AI Image (SDXL)
...
- 01-data/cleaned/real/<group_id>.png
- 01-data/cleaned/fake/<group_id>.png
...
- Luu 01-data/splits/train.csv, val.csv, test.csv
...
-> [G1] standardize + map group_id + save 01-data/cleaned/{real,fake}
...
-> [G5] group-aware split -> 01-data/splits/*.csv
-> [G6] runtime transform trong DataLoader -> training

## 6. Dau ra ky vong

- 01-data/cleaned/real/*.png
- 01-data/cleaned/fake/*.png
- 01-data/reports/* (integrity log, duplicate report, resolution plot)
